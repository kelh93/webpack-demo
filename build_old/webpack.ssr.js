...
const MyCleanPlugin = require('./MyCleanPlugin');
...
module.exports = function(buildConfig = {}) {
    ...
    const plugins = [
		...
		new MyCleanPlugin({
			cleanDir: [path.join(buildConfig.rootDir, 'dist'), path.join(buildConfig.rootDir, 'app/public')],
			srcDir: path.join(buildConfig.rootDir, 'dist'),
			tarDir: path.join(buildConfig.rootDir, 'app/public'),
		})
	];
    if (useCache) {
